...
query_path="/home/vader/Documents/MSc-project/data/raw_data/CJIE_genes/CJIE_genes.fasta"

out_path="/home/vader/Documents/MSc-project/Results/CJIE_determining/CJIE_key_genes_blast_result.csv"

blastn -db "$db_path" -query "$query_path" -outfmt "10 delim=, std qlen slen" -evalue 10 -num_threads 12 -out "$out_path"

'

Rscript /home/vader/Documents/MSc-project/coding/linux_shell_script/CJIE_key_gene_blast_analysis.R
