...
## Appendix script 8: R markdown (.Rmd) for T6SS identification and plot generation
...
## Appendix script 9: R markdown (.Rmd) for CJIE-3 identification with the 3 key genes
...
## Appendix script 10: R markdown (.Rmd) for locating potenital CJIE-3 regions and identify the regions with any 3 key genes 
...
## Appendix script 11: R markdown (.Rmd) for analysing CJIE-3 regions and output them as .fna file for annotation 
...
## Appendix script 12: R markdown (.Rmd) for generating plots for CJIE-3 
...
## Appendix script 13: R markdown (.Rmd) for summarize the proportion of T6SS and CJIE-3 
...
## Appendix script 14: Linux shell scripts used in this analysis
